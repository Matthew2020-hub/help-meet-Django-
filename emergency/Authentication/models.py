...
class User(AbstractUser):
    ...
    name = models.CharField(
        max_length=250, verbose_name="Full Name", blank=False, null=True
    )
    house_address = models.CharField(
        max_length=500, unique=True, blank=False, null=True
    )
...
class Estate(models.Model):
    ...
    estate_id = models.UUIDField(
        default=uuid.uuid4, editable=False, unique=True, null=True, blank=True
    )
    estate_address = models.CharField(
        max_length=400, unique=True, blank=False
    )
